...
// It should be #include but I had to copy-paste it to make it one file to submit for the task.
...
namespace
{
    ...
    inline void freeze(int x) { val[x] = nsolid++; }
...
int antiqsort(int n, int *a)
{
    ...
    sort1(ptr.begin(), ptr.end(), cmp<int>);
    return ncmp;
}
...
int main()
{
    ...
    int *data = new int[max_count];

    // Test antiqsort
    int comparisons = antiqsort(max_count, data);
    std::cerr << "Number of comparisons: " << comparisons << std::endl;
